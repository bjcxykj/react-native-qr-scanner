  ...
  render() {
    ...
    return (
      <View
        ...
        >
          <View style={[styles.topButtonsContainer, topViewStyle]}>
            {renderTopView()}
          </View>
          <QRScannerView {...ScanViewProps} returnSize={this.barCodeSize} />
          <View style={[styles.bottomButtonsContainer, bottomViewStyle]}>
            {renderBottomView()}
          </View>
        </RNCamera>
      </View>
...
QRScanner.propTypes = {
  ...
  cornerBorderHotizontalLength: PropTypes.number,
  cornerBorderVerticalLength: PropTypes.number,
